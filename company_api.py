...
def openapi():
    def paid(price, summary, schema):
        return {"post":{"summary":summary,"operationId":summary.lower().replace(" ","_"),"security":[],"x-payment-info":{"pricingMode":"fixed","price":price,"currency":"USD","protocols":["x402"]},"requestBody":{"required":True,"content":{"application/json":{"schema":schema}}},"responses":{"402":{"description":"Payment Required","content":{"application/json":{"schema":{"type":"object"}}}},"200":{"description":"Paid JSON result","content":{"application/json":{"schema":{"type":"object"}}}}}}}
